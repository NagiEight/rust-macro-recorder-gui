...
// The main App component now acts as the central layout container.
// It wraps the entire application with the UIProvider to make state accessible.
const Home = () => {
  return (
    <UIProvider>
      <div className="bg-zinc-900 text-gray-300 w-full h-screen font-inter overflow-hidden">
        ...
        <header className="bg-zinc-800 flex items-center justify-between px-3 py-1.5 shadow-md">
          ...
          <div className="text-white text-sm font-semibold">
            App.jsx - my-vscode-app - Visual Studio Code
          </div>
